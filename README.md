...
The objective of this task is to detect sentiments in tweets. For the sake of simplicity, we say a tweet contains hate speech if it has a negative sentiment associated with it. So, the task is to classify racist or sexist tweets from other tweets.

Formally, given a training sample of tweets and labels, where label is given, positive,negative and neutral. your objective is to predict the labels on the given test dataset.
